...
After running code, I saw that there are 8 total batman films within the data.
...
The second code is wrong because it is in the wrong order.
...
After running the code i found the longest movies was the Cure for Insomnia (5220 minutes), The oldest movie is the Blacksmith made in 1893.
...
After running the code I saw that there were 1,248 movies made.
...
After running gthe code I found 4 movies that meet those requirements.
...
After looking at the code I saw that there are 3 movies with the title Harry Potter in it.Chamber of secrets, Prisoner of Azkabean, and the Sorcerer's Stone. The one with the highets rating was the Prisoner of azkaban and the one with the highest vote being the Sorcerer's stone. 
